...
# Eg:4
# ! print the output of 7th multipilcation table from 21 to 43
        # --> method:1
...
# !------------> while loop
#  ? while i used when we do not know the number of times the loop have to run
...
# for loop practisee
# write program to display sum of odd numbers and even I
# numbers that fall between
# 12  and 37 (including both numbers)

#Assesment
#1.) cats and mouse :Hacker rank
#2.) Print the factorla of 8 using for the loop
#3.) Write a program to display sum of number using while loop
#   numbers that fall between
#  12 and 37 (including both numbers)
# 4.)
